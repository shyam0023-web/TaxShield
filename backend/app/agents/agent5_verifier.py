...
CONSISTENCY_PROMPT = """You are a legal verification assistant. Given a draft reply to a GST notice,
...
ADVERSARIAL_PROMPT = """You are a senior GST adjudicating officer reviewing a taxpayer's draft reply.
